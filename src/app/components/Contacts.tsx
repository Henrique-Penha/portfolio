...
const Contacts = () => {
    return(
        <section id="contacts" className="px-5 py-8 bg-gradient-to-b from-black to-indigo-100">
                <h2 className="mb-5 text-center text-white text-4xl font-bold">Contatos</h2>
            <div className="flex gap-10 justify-center py-5">
                ...
                <Link href="https://www.linkedin.com/in/henrique-penha">
                    <FontAwesomeIcon icon={faLinkedin} className="h-24 text-blue-900"/>
                </Link>
                <Link href="mailto:henriquedsp34@gmail.com">
                    <FontAwesomeIcon icon={faEnvelope} className="h-24 text-green-300"/>
                </Link>
            </div>
        </section>
    )
